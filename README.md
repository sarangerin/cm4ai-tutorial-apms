...
4. Create and visualize a protein-protein interaction (PPI) network from the AP-MS data, and
...
3. Review and run the tutorial scripts
   ...
   3. Generate embeddings with cellmaps_ppi_embedding: [View Script](src/generate_embeddings.py)
   4. Generate a PPI network based on the embedding and visualize results: [View Notebook](src/generate_network.ipynb)
